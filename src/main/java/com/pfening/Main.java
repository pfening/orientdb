...
public class Main {
    ...
    private static void createSchema(ODatabaseSession db) {
        ...
        if (person.getProperty("name") == null) {
            ...
            person.createIndex("Person_name_index", OClass.INDEX_TYPE.DICTIONARY, "name");
         }

        if (location.getProperty("name") == null) {
            location.createProperty("name", OType.STRING);
            location.createIndex("Location_name_index", OClass.INDEX_TYPE.DICTIONARY, "name");
        }

        if (location.getProperty("country") == null) {
            location.createProperty("country", OType.STRING);
            location.createIndex("Location_country_index", OClass.INDEX_TYPE.UNIQUE, "country");
        }
    ...
    private static OVertex createLocation(ODatabaseSession db, String name, String country) {
